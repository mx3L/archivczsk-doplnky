...
LISTING_ITER_RE = '<div class=\"item\">\s*<div class=\"image\">.+?<img.+?src=\"(?P<img>[^\"]+)\" />.+?</div>\s*<div class=\"text\">\s*<h2><a href=\"(?P<url>[^\"]+)\">(?P<title>[^<]+)</a></h2>\s*<div class=\"info\">\s*<div class=\"section\">.+?<a href=\"(?P<section_url>[^\"]+)\">(?P<section_title>[^<]+)</a></div>\s*<div class=\"length\">.+?(?P<length>\d{2}:\d{2}:\d{2})</div>\s*<div class=\"date\">.+?(?P<date>\d{1,2}[^<]+)</div>\s*</div>'
